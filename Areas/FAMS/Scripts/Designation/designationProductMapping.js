...
$(document).ready(function () {
    ...
    function SalesLeadList() {
        ...
        self.getOfficeDesgArea = function () {
            ...
            $.ajax({
                type: "GET",
                url: '/FAMS/Designation/GetDesignationProductMapping?id=' + setng,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    self.SngArea(data);
        ...
        self.removeDetail = function (receiveDetail) {
            ...
            $.getJSON("/FAMS/Designation/RemoveDesignationProductMap/?id=" + receiveDetail.Id, null, function (data) {
        ...
        self.LoadProducts = function () {
            $.ajax({
                type: "GET",
                url: '/FAMS/Product/GetAllProducts',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    self.Products(data);
        ...
        self.addData = function () {
            ...
            $.ajax({
                type: "POST",
                url: '/FAMS/Designation/SaveDesignationProductMapping',
                data: ko.toJSON(quesDetails),
                contentType: "application/json",
                success: function (data) {
                    $('#successModal').modal('show');
