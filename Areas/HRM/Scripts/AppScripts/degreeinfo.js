    ...
    $(function () {
        $("#jqGrid").jqGrid({
            ...
            colModel: [
                ...
                {
                    key: false, hidden: true, name: 'DegreeLevel', width: 140, index: 'DegreeLevel', editable: true, edittype: "select", editoptions: { dataUrl: '/HRM/Degree/GetDegreeLevels', cacheUrlData: true }, editrules: { edithidden: true, required: true },
                ...
                {
                    key: false, hidden: true, name: 'DegreeMajor', width: 140, index: 'DegreeMajor', editable: true, edittype: "select", editoptions: { dataUrl: '/HRM/Degree/GetDegreeMajors', cacheUrlData: true }, editrules: { edithidden: true, required: true },
