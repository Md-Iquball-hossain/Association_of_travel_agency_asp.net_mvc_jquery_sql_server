$(document).ready(function () {
    ...
    function populateDesignations(isEdit) {
        ...
        $.ajax({
            url: '/HRM/Employee/GetCorrespondingGrade',
            type: "GET",
    ...
    function updateDesignationCallBack(isEdit, selectedGradeId, designationCombo) {
        var url = '/HRM/Employee/GetCorrespondingDesignations/?gradeid=' + selectedGradeId;
        //debugger;
        $(designationCombo)
    ...
    $(function () {
        $("#jqGrid").jqGrid({
            ...
            datatype: 'json',
            mtype: 'Get',
            colNames: ['Id', 'First Name', 'Last Name', 'Date Of Birth', 'FatherFirstName', 'FatherLastName', 'Father Name', 'MotherFirstName', 'MotherLastName', 'Mother Name', 'CountryId', 'Gender', 'MaritalStatus', 'BloodGroup', 'NID', 'Religion', 'OfficeId', 'Employeetype Name'],
            colModel: [
               ...
               // { name: 'Edit', search: false, index: 'Edit', width: 60, sortable: false, formatter: editLink },
                ...
                { key: false, name: 'FirstName', index: 'FirstName', editable: true, formoptions: { colpos: 1, rowpos: 1, label: "First Name"}, searchoptions: { sopt: ['eq', 'ne', 'cn'] }, classes: "grid-col" },
                { key: false, name: 'LastName', index: 'LastName', editable: true,  formoptions: { colpos: 2, rowpos: 1, label: "Last Name"}, searchoptions: { sopt: ['eq', 'ne', 'cn'] }, classes: "grid-col" },
                {
                    name: "DateOfBirth", index: 'DateOfBirth', label: "DateOfBirth", formatter: "date", editable: true, formoptions: { colpos: 1, rowpos: 2, label: "Date Of Birth " }, edittype: "text",
                    editoptions: {
                ...
                { key: false, hidden: true, name: 'FatherFirstName', index: 'FatherFirstName', editable: true, editrules: { edithidden: true }, formoptions: { colpos: 2, rowpos: 2, label: "Father FirstName" } },
                { key: false, hidden: true, name: 'FatherLastName', index: 'FatherLastName', editable: true, editrules: { edithidden: true }, formoptions: { colpos: 1, rowpos: 3, label: "Father LastName" } },
                ...
                { key: false, hidden: true, name: 'MotherFirstName', index: 'MotherFirstName', editable: true, editrules: { edithidden: true}, formoptions: { colpos: 2, rowpos: 3, label: "Mother FirstName" } },
                { key: false, hidden: true, name: 'MotherLastName', index: 'MotherLastName', editable: true, editrules: { edithidden: true}, formoptions: { colpos: 1, rowpos: 4, label: "Mother LastName" } },
                ...
                {
                    key: false, hidden: true, name: 'CountryId', width: 140, index: 'CountryId', editable: true, edittype: "select", editoptions: { dataUrl: '/HRM/Employee/GetCorrespondingCountries', cacheUrlData: true }, editrules: { edithidden: true, required: true },
                    formoptions: { colpos: 2, rowpos: 4, label: "Nationality"}
                },
                { key: false, hidden: true, name: 'Gender', index: 'Gender', editable: true, edittype: "select", editoptions: { dataUrl: '/HRM/Employee/GetGenders', cacheUrlData: true }, editrules: { edithidden: true, required: true }, formoptions: { colpos: 1, rowpos: 5, label: "Gender" }, searchoptions: { sopt: ['eq', 'ne', 'cn'] }, classes: "grid-col" },
                { key: false, hidden: true, name: 'MaritalStatus', index: 'MaritalStatus', editable: true, edittype: "select", editoptions: { dataUrl: '/HRM/Employee/GetMaritalStatuses', cacheUrlData: true }, editrules: { edithidden: true, required: true }, formoptions: { colpos: 2, rowpos: 5, label: "Marital Status" }, searchoptions: { sopt: ['eq', 'ne', 'cn'] }, classes: "grid-col" },
                { key: false, hidden: true, name: 'BloodGroup', index: 'BloodGroup', editable: true, edittype: "select", editoptions: { dataUrl: '/HRM/Employee/GetBloodGroups', cacheUrlData: true }, editrules: { edithidden: true, required: true }, formoptions: { colpos: 1, rowpos: 6 }, searchoptions: { sopt: ['eq', 'ne', 'cn'] }, classes: "grid-col" },
                { key: false, name: 'NID', index: 'NID', width: 148, editable: true, editrules: { edithidden: true, custom_func: validateNID, custom: true }, formoptions: { colpos: 2, rowpos: 6, label: "NID#" }, searchoptions: { sopt: ['eq', 'ne', 'cn'] }, classes: "grid-col" },
                { key: false, hidden: true, name: 'Religion', index: 'Religion', editable: true, editrules: { edithidden: true }, edittype: "select", editoptions: { dataUrl: '/HRM/Employee/GetReligions', cacheUrlData: true }, formoptions: { colpos: 1, rowpos: 7 }, searchoptions: { sopt: ['eq', 'ne', 'cn'] }, classes: "grid-col" },
                 {
                     key: false, hidden: true, name: 'OfficeId', width: 140, index: 'OfficeId', editable: true, edittype: "select", editoptions: { dataUrl: '/HRM/Office/GetOffices', cacheUrlData: true }, editrules: { edithidden: true, required: true },
                     formoptions: { colpos: 2, rowpos: 7, label: "Office"}
                 },
                 //{
                 //    key: false, hidden: true, name: 'OfficeId', width: 140, index: 'OfficeId', editable: true, edittype: "select", editoptions: { dataUrl: '/HRM/Office/GetOffice', cacheUrlData: true }, editrules: { edithidden: true, required: true },
                 //    formoptions: { colpos: 2, rowpos: 4, label: "Office"}
                 //}
               //{
        ...
        {
            zIndex: 100,
            url: "/HRM/Employee/DeleteEmployee",
            closeOnEscape: true,
