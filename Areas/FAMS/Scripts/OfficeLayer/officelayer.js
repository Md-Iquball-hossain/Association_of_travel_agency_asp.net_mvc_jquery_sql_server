$(document).ready(function () {
    function populateParentOffice(isEdit) {
        ...
        $.ajax({
            url:'/FAMS/Office/GetParentOffices/?officelayerid=' + selectedOfficeLayerId,
            type: "GET",
     ...
     $(function () {
        $("#jqGrid").jqGrid({
            ...
            onSelectRow: function (rowid, selected){
                if (rowid != null) {
                    ...
                    jQuery("#jqGridDetails").jqGrid('setGridParam', { url: "/FAMS/Office/GetOfficeByLayers/?officelevel=" + dataFromCellByColumnName, datatype: 'json' }); // the last setting is for demo only
        ...
        {
            zIndex: 100,
            url: '/FAMS/OfficeLayer/SaveOfficeLayer',
            closeOnEscape: true,
            width: 'auto',
            height: 'auto',
            closeAfterEdit: true,
        ...
        {
            zIndex: 100,
            url: "/FAMS/OfficeLayer/DeleteOfficeLayer",
            closeOnEscape: true,
