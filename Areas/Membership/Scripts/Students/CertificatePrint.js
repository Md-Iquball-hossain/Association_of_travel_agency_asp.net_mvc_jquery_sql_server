$(document).ready(function () {
    function CertificatePrintVM() {
        ...
        self.LoadTraineeCourses = function () {
            self.Courses([]);
            return $.ajax({
                type: "GET",
                url: '/Membership/Students/GetTraineeCourses?trid=' + self.TraineeNo(),
        ...
        self.loadTypes = function () {
            ...
            return $.ajax({
                type: "GET",
                url: '/Membership/Settings/GetCertificateTypes?companyid='+ companyid +'&courseid=' + self.Course(),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    self.CTypes(data);
        ...
        self.loadBooks = function () {
            return $.ajax({
                type: "GET",
                url: '/Membership/Students/GetCertificateBooks?type=' + self.CertificateType(),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    self.Books(data);
        ...
        self.LoadAvailableList = function (searchTerm, callback) {
            ...
            if (self.CertificateRegisterId() > 0) {
                $.ajax({
                    type: "POST",
                    url: '/Membership/Students/GetAvailableCertificateNo?bookid=' + self.CertificateRegisterId(),
        ...
        self.saveCertificate = function () {
                $.ajax({
                    type: "POST",
                    url: '/Membership/Students/SaveCertificate',
                    data: ko.toJSON(this),
                    contentType: "application/json",
                    success: function (data) {
                        $('#successModal').modal('show');
        ...
        self.getcertificateList = function () {
            return $.ajax({
                type: "GET",
                url: '/Membership/Students/CertificateList?traineeid=' + self.TraineeNo(),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
        ...
        self.LoadCertificate = function (data) {
            if (data.Id > 0) {
                return $.ajax({
                    type: "GET",
                    url: '/Membership/Students/CertificatebyId?cerid=' + data.Id,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (data) {
        ...
        self.GetMemberMembershipCertificate = function (data) {
            window.open('/Membership/Students/GetStudentCertificate?reportTypeId=PDF&certificateid=' + data.Id, '_blank');

        }

        self.InitialValueLoad = function () {
            self.LoadTraineeCourses();
            self.getcertificateList();
    ...
    pavm.TraineeNo(pavm.queryString("TraineeId"))
