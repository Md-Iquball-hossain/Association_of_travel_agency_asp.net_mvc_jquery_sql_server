$(document).ready(function () {
    $(function () {
        $("#jqGrid").jqGrid({
            ...
            datatype: 'json',
            mtype: 'Get',
            colNames: ['Id', 'Year', 'CurrentYear', 'Quarter One', 'Quarter One Text', 'Quarter Two', 'Quarter Two Text', 'Quarter Three', 'Quarter Three Text', 'Quarter Four', 'Quarter Four Text'],
            colModel: [
