$(document).ready(function () {
    $(function () {
        $("#jqGrid").jqGrid({
            url: "/FAMS/OfficeDesignationSetting/GetAllDesignationSettings",
            datatype: 'json',
            mtype: 'Get',
            ...
            colModel: [
                ...
                {
                    key: false, hidden: true, name: 'OfficeId', width: 140, index: 'OfficeId', editable: true, edittype: "select", editoptions: { dataUrl: '/FAMS/Office/GetAllOffice', cacheUrlData: true }, editrules: { edithidden: true, required: true },
                ...
                {
                    key: false, hidden: true, name: 'DesignationId', width: 140, index: 'DesignationId', editable: true, edittype: "select", editoptions: { dataUrl: '/FAMS/Designation/GetDesignationList', cacheUrlData: true }, editrules: { edithidden: true, required: true },
                ...
                {
                    key: false, hidden: true, name: 'ParentDesignationSettingId', width: 140, index: 'ParentDesignationSettingId', editable: true, edittype: "select", editoptions: { dataUrl: '/FAMS/OfficeDesignationSetting/GetDesignationSettingList', cacheUrlData: true }, editrules: { edithidden: true },
        ...
        {
            zIndex: 100,
            url: "/FAMS/OfficeDesignationSetting/SaveDesignationSetting",
            closeOnEscape: true,
            closeAfterEdit: true,
            width: 'auto',
            height: 'auto',
        ...
        },
        {
         ...
         {
             zIndex: 100,
             url: "/FAMS/OfficeDesignationSetting/DeleteOfficeDesignationSetting",
             closeOnEscape: true,
