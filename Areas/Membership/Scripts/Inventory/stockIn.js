$(document).ready(function () {
    function TranDetail() {
        ...
        self.Quantity = ko.observable(0).extend({ required: "Please enter a quantity", min: 1 });
    ...
    function StockInVM() {
        ...
        self.FromOfficeId = ko.observable(0);
        self.ToOfficeId = ko.observable(userCompanyId);
        ...
        self.Submit = function () {
            ...
            if (self.IsValid()) {
                $.ajax({
                    url: '/Membership/Inventory/SaveStockIn',
                    type: 'POST',
                    contentType: 'application/json',
        ...
        self.Reload = function () {
            window.location.href = '/Membership/Inventory/StockIn'
        };
    }
