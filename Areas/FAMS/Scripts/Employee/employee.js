$(document).ready(function () {
    ...
    function populateDesignations(isEdit) {
        ...
        $.ajax({
            url: '/FAMS/Employee/GetCorrespondingGrade',
            type: "GET",
    ...
    function updateDesignationCallBack(isEdit, selectedGradeId, designationCombo) {
        var url = '/FAMS/Employee/GetCorrespondingDesignations/?gradeid=' + selectedGradeId;
        //
        $(designationCombo)
    ...
    $(function () {
        $("#jqGrid").jqGrid({
            url: "/FAMS/Employee/GetEmployeeList",
            datatype: 'json',
            mtype: 'Get',
            ...
            colModel: [
                ...
                //{ key: false, hidden: true, name: 'Nationality', index: 'Nationality', editable: true, edittype: "select", editoptions: { dataUrl: '/FAMS/Employee/GetAllNationality', cacheUrlData: true }, editrules: { edithidden: true, required: true }, formoptions: { colpos: 2, rowpos: 4, label: "Nationality" }, searchoptions: { sopt: ['eq', 'ne', 'cn'] }, classes: "grid-col" },
                { key: false, hidden: true, name: 'Gender', index: 'Gender', editable: true, edittype: "select", editoptions: { dataUrl: '/FAMS/Employee/GetGenders', cacheUrlData: true }, editrules: { edithidden: true, required: true}, formoptions: { colpos: 2, rowpos: 5, label: "Gender" }, searchoptions: { sopt: ['eq', 'ne', 'cn'] }, classes: "grid-col" },
                { key: false, hidden: true, name: 'MaritalStatus', index: 'MaritalStatus', editable: true, edittype: "select", editoptions: { dataUrl: '/FAMS/Employee/GetMaritalStatuses', cacheUrlData: true }, editrules: { edithidden: true, required: true }, formoptions: { colpos: 1, rowpos: 6, label: "Marital Status" }, searchoptions: { sopt: ['eq', 'ne', 'cn'] }, classes: "grid-col" },
                { key: false, hidden: true, name: 'BloodGroup', index: 'BloodGroup', editable: true, edittype: "select", editoptions: { dataUrl: '/FAMS/Employee/GetBloodGroups', cacheUrlData: true }, editrules: { edithidden: true, required: true }, formoptions: { colpos: 2, rowpos: 6 }, searchoptions: { sopt: ['eq', 'ne', 'cn'] }, classes: "grid-col" },
                ...
                { key: false, hidden: true, name: 'Religion', index: 'Religion', editable: true, editrules: { edithidden: true, required: true }, edittype: "select", editoptions: { dataUrl: '/FAMS/Employee/GetReligions', cacheUrlData: true }, formoptions: { colpos: 2, rowpos: 7 }, searchoptions: { sopt: ['eq', 'ne', 'cn'] }, classes: "grid-col" },
                { key: false, hidden: true, name: 'EmployeeType', index: 'EmployeeType', editable: true, edittype: "select", editoptions: { dataUrl: '/FAMS/Employee/GetEmployeeType', cacheUrlData: true }, editrules: { edithidden: true, required: true }, formoptions: { colpos: 1, rowpos: 8, label: "Emplyee Type" }, searchoptions: { sopt: ['eq', 'ne', 'cn'] }, classes: "grid-col" },
        ...
        {
            zIndex: 100,
            url: '/FAMS/Employee/SaveEmployee',
            closeOnEscape: true,
            closeAfterEdit: true,
            recreateForm: true,
            width: 'auto',
        ...
        {
            zIndex: 100,
            url: "/FAMS/Employee/DeleteEmployee",
            closeOnEscape: true,
