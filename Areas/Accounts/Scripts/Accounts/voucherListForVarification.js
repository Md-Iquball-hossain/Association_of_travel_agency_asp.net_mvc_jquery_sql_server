...
$(document).ready(function () {
    ...
    function VoucherList() {
        ...
        self.Details = function (data) {
            ...
            //    Id: 13300,
            //    Menu: 'Voucher Edit',
            //    Url: '/Cardiac/Accounts/GetVoucherPrintByVoucherNo?reportTypeId=PDF&voucherNo=',
        ...
        $("#submit").on('click', function (event) {
            ...
            $.each(self.CompanyProfileIds(), function (index, value) {
                $("#voucherVerifierForm").append("<input type=\"hidden\" name=\"companyIds\" value=" + value + ">")
            })
            return true;
        })
        ...
        function pageLink(currentFilter, page, searchDate) {
            var url = "/Accounts/Accounts/VoucherListForVerification?page=" + page + "&currentFilter=" + currentFilter + "&searchDate=" + searchDate;
            $.each(self.CompanyProfileIds(), function (index, value) {
        ...
        self.saveVoucherVerification = function () {
            ...
            $.ajax({
                type: "POST",
                url: '/Accounts/Accounts/SaveVouchersVerified',
        ...
        self.Refresh = function () {
            var url = "/Accounts/Accounts/VoucherListForVerification?page=" + page + "&searchDate=" + searchDate;
            $.each(self.CompanyProfileIds(), function (index, value) {
                url += "&companyIds=" + value
            })
            window.location.href = url;
    ...
    ko.applyBindings(vm, document.getElementById("VoucherVerificationList"));
});