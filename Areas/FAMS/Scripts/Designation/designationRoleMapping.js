...
$(document).ready(function () {
    ...
    function SalesLeadList() {
        ...
        self.getOfficeDesgArea = function () {
            ...
            $.ajax({
                type: "GET",
                url: '/FAMS/Designation/GetDesignationRoleMapping?id=' + setng,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    self.SngArea(data);
        ...
        self.removeDetail = function (receiveDetail) {
            ...
            $.getJSON("/FAMS/Designation/RemoveDesignationRoleMap/?id=" + receiveDetail.Id, null, function (data) {
        ...
        self.LoadRoles = function () {
            $.ajax({
                type: "GET",
                url: '/FAMS/Designation/GetAllRoles',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    self.Roles(data);
        ...
        self.addData = function () {
            ...
            $.ajax({
                type: "POST",
                url: '/FAMS/Designation/SaveDesignationRoleMapping',
                data: ko.toJSON(quesDetails),
                contentType: "application/json",
                success: function (data) {
                    $('#successModal').modal('show');
