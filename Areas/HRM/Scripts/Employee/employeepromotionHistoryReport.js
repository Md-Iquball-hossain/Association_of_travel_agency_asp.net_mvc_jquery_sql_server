...
$(document).ready(function () {
    function historyVM() {
        ...
        self.Search = function () {
            $.ajax({
                type: "GET",
                url: '/HRM/Employee/GetPromotionHisWiseEmployee?fromDate=' + self.FromDate() + '&toDate=' + self.ToDate(),
        ...
        self.setUrl = ko.computed(function () {
            self.Link1('/HRM/Employee/GetPromotionEmpReport?reportTypeId=PDF&fromDate=' + self.FromDate() + '&toDate=' + self.ToDate());
            self.Link2('/HRM/Employee/GetPromotionEmpReport?reportTypeId=Excel&fromDate=' + self.FromDate() + '&toDate=' + self.ToDate());
            self.Link3('/HRM/Employee/GetPromotionEmpReport?reportTypeId=Word&fromDate=' + self.FromDate() + '&toDate=' + self.ToDate());
        });
    };
