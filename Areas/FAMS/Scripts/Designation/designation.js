$(document).ready(function () {
    $(function () {
        $("#jqGrid").jqGrid({
            url: "/FAMS/Designation/GetDesignations",
            datatype: 'json',
            mtype: 'Get',
            ...
            colModel: [
                ...
                {
                    key: false, hidden: true, name: 'ParentId', width: 140, index: 'ParentId', editable: true, edittype: "select", editoptions: { dataUrl: '/FAMS/Designation/GetParentDesignationList', cacheUrlData: false }, editrules: { edithidden: true },
        ...
        {
            zIndex: 100,
            url: '/FAMS/Designation/SaveDesignations',
            closeOnEscape: true,
            closeAfterEdit: true,
            width: 'auto',
            height: 'auto',
        ...
        {
            zIndex: 100,
            url: "/FAMS/Designation/DeleteDesign",
            closeOnEscape: true,
