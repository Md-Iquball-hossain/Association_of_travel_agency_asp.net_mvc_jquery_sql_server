...
$(document).ready(function () {
    ...
    function SalesLeadList() {
        ...
        self.getOfficeLayers = function () {
            ...
            $.ajax({
                type: "GET",
                url: '/FAMS/OfficeLayer/GetOfficeLayers',
        ...
        self.getOfficeByOfficeLayer = function () {
            ...
            $.ajax({
                type: "GET",
                url: '/FAMS/Office/GetOfficeByLayer?officelayerid=' + officeLayer,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    self.Offices(data);
         ...
         self.getDesignationByOffice = function () {
            ...
            $.ajax({
                type: "GET",
                url: '/FAMS/OfficeDesignationSetting/GetDesignationSettingListByOffice?OfficeId=' + office,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
         ...
         self.getOfficeDesgArea = function () {
             ...
             $.ajax({
                 type: "GET",
                 url: '/FAMS/OfficeDesignationArea/GetOfficeDesgArea?id=' + setng,
                 contentType: "application/json; charset=utf-8",
                 dataType: "json",
                 success: function (data) {
                     self.SngArea(data);
         ...
         self.removeDetail = function (receiveDetail) {
             ...
             $.getJSON("/FAMS/OfficeDesignationArea/UpdateOfficeDesignationArea/?id=" + receiveDetail.Id, null, function (data) {
         ...
         self.addDetail = function (receiveDetail) {
             ...
             $.ajax({
                 type: "POST",
                 url: '/FAMS/OfficeDesignationArea/SaveOfficeDesignationArea',
        ...
        // self.LoadDivision = function () { /FAMS/OfficeDesignationSetting/GetDesignationSettingListByOffice?OfficeId=" + self.OfficeId()
        //     return $.getJSON("/FAMS/OfficeDesignationArea/GetAllDivisions",
        //        null,
        //        function (data) {
        //            self.Divisions(data);
        //        });
        ...
        self.LoadDivision = function () {
            $.ajax({
                type: "GET",
                url: '/FAMS/OfficeDesignationArea/GetAllDivisions',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    self.Divisions(data);
        ...
        self.getDistrictByDivision = function () {
            ...
            $.ajax({
                type: "GET",
                url: '/FAMS/OfficeDesignationArea/GetDistrictByDivision?id=' + divisionId,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    self.Districts(data);
        ...
        self.getUpzilaByDistrict = function () {
            ...
            $.ajax({
                type: "GET",
                url: '/FAMS/OfficeDesignationArea/GetUpzilaByDistrict?id=' + districtId,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    self.Upazilas(data);
        ...
        self.getByOfficeDesignationMap = function () {
            ...
            if (self.DistrictId()) {
                $.ajax({
                    type: "GET",
                    url: '/FAMS/OfficeDesignationArea/GetByOfficeDesignationMap?upazilaOrThana=' + area + '&dist=' + self.DistrictId() + '&settingId=' + self.DesignationId(),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (data) {
                        self.LoadData(data);
        ...
        self.LoadDistrict = function () {
            return $.getJSON("/FAMS/SalesLead/GetAllDistricts",
                null,
                function (data) {
                    self.Districts(data);
                });
        ...
        self.LoadThanaByDistrict = function (districtId) {
            return $.getJSON("/FAMS/SalesLead/GetThanasByDistrict/?districtId=" + districtId, null, function (data) {
                self.Thanas(data);
            });
        }
        self.LoadProducts = function () {
            return $.getJSON("/FAMS/SalesLead/GetAllProducts", null, function (data) {
                self.Designations(data);
            });
        }
        ...
        //    $.getJSON("/FAMS/SalesLead/GetProspectiveSalesLeads", null, function (data) {
        ...
        //    $.getJSON("/FAMS/SalesLead/GetQuestionSetForLead/?leadId=" + self.SalesLeadId(), null, function (data) {
        //        //self.shouldShowDetail(true);
        ...
        //    //self.QuestionAnswerSet([]);
        //    self.Initialize();
        //    $.getJSON("/FAMS/SalesLead/GetSalesLeadForEdit/?leadId=" + self.SalesLeadId(), null, function (data) {
        //        self.Id(data.Id);
        //        self.Name(data.Name);
        ...
        //    $.ajax({
        //        type: "POST",
        //        url: '/FAMS/SalesLead/SaveQuestionnaire',
        //        data: ko.toJSON(quesDetails),
        //        contentType: "application/json",
        //        success: function (data) {
        //            $('#successModal').modal('show');
        ...
        //    $.ajax({
        //        type: "POST",
        //        url: '/FAMS/SalesLead/SaveFollowUpTime',
        //        data: ko.toJSON(self),
        //        contentType: "application/json",
        //        success: function (data) {
        //            $('#successModal').modal('show');
        ...
        self.Save = function () {
            ...
            $.ajax({
                type: "POST",
                url: '/FAMS/SalesLead/SaveSalesLead',
                data: ko.toJSON(quesDetails),
                contentType: "application/json",
                success: function (data) {
                    $('#successModal').modal('show');
