$(document).ready(function () {
    $(function () {
        $("#jqGrid").jqGrid({
            url: "/HRM/SalaryItem/GetAllFields",
            datatype: 'json',
            mtype: 'Get',
            colNames: ['Id', 'Name', 'TotalSalaryPercentageDecimal'], //validatePositive
            colModel: [
                ...
                { key: false, name: 'TotalSalaryPercentageDecimal', index: 'TotalSalaryPercentageDecimal', label: 'Total Salary Percentage', editable: true, editrules: { custom_func: validatePositive, custom: true, required: true }, searchoptions: { sopt: ['eq', 'ne', 'cn'] } }
            ],
