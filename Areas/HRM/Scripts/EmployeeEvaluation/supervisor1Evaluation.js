$(document).ready(function () {
    ...
    function KPI(data) {
        ...
        self.KPIMarksEvaluator1 = ko.observable(data.KPIMarksEvaluator1 ? data.KPIMarksEvaluator1 : 0).extend({ required: true, min: 0, max: 10 });
    ...
    function superOneEvaluation() {
        ...
        self.LoadInitial = function () {
            $.getJSON("/HRM/Appraisal/GetSupervisor1Evaluation/?empid=" + empid + "&evaluationYear=" + evaluationyear, null, function (data) {
        ...
        self.Submit = function () {
            if (self.errors().length == 0) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/HRM/Appraisal/SubmitSupervisorOneEvaluation/",
    ...
    var vm = new superOneEvaluation();
    vm.LoadInitial();
    ko.applyBindings(vm, document.getElementById("supervisorOneEvaluation"));
});