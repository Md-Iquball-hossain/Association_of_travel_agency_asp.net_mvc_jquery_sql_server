    ...
    $(function () {
        $("#jqGrid").jqGrid({
            ...
            colModel: [
                ...
                {
                    key: false, hidden: true, name: 'ModuleId', width: 140, index: 'ModuleId', editable: true, edittype: "select", editoptions: { dataUrl: '/Submodule/GetCorrespondingModules', cacheUrlData: true }, editrules: { edithidden: true, required: true },
