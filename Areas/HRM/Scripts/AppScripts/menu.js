$(document).ready(function () {
    ...
    function populateSubmodules(isEdit) {
        ...
        $.ajax({
            url: '/HRM/Submodule/GetCorrespondingModules',
            type: "GET",
    ...
    function updateSubmoduleCallBack(isEdit, selectedModuleId, submoduleCombo) {
        var url = '/HRM/Menu/GetCorrespondingSubModules/?moduleId=' + selectedModuleId;
        $(submoduleCombo)
