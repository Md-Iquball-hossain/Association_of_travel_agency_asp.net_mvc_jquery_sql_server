...
$(document).ready(function () {
    ...
    function EmpDesignationMappingVm() {
        ...
        self.getData = function (prefix) {
            //$.getJSON("/FAMS/Employee/GetEmployeeNumberList?prefix=" + prefix, function (data) {
            $.getJSON("/FAMS/Employee/GetEmployeeNumberList", function (data) {
        ...
        self.LoadOfficeLayers = function(){
            return $.getJSON("/FAMS/OfficeLayer/GetOfficeLayers", null, function (data) {
                self.OfficeLayers(data);
            });
        }
        self.LoadOffices = function () {
            if (self.OfficeLayerId() > 0) {
                return $.getJSON("/FAMS/Office/GetOfficeByLayer?officelayerid=" + self.OfficeLayerId(), null, function (data) {
                    self.Offices(data);
                });
            }
        }
        self.LoadDesignations = function () {
            if (self.OfficeId() > 0) {
                return $.getJSON("/FAMS/OfficeDesignationSetting/GetDesignationSettingListByOffice?OfficeId=" + self.OfficeId(), null, function (data) {
        ...
        self.LoadDesignatedEmployees = function () {
            if (self.DesignationId() > 0) {
                return $.getJSON("/FAMS/OfficeDesignationSetting/GetDesignatedEmployees?SettingId=" + self.DesignationId(), null, function (data) {
        ...
        self.RemoveDesignation = function (line) {
            ...
            $.ajax({
                type: "POST",
                url: '/FAMS/OfficeDesignationSetting/RemoveEmployeeDesignation',
        ...
        self.Save = function () {
            ...
            $.ajax({
                type: "POST",
                url: '/FAMS/OfficeDesignationSetting/SaveEmployeeDesignation',
                data: ko.toJSON(postData),
                contentType: "application/json",
                success: function (data) {
                    $('#successModal').modal('show');
