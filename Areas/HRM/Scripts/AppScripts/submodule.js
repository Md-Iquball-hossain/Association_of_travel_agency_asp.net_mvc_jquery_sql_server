$(document).ready(function () {
    $(function () {
        $("#jqGrid").jqGrid({
            url: "/HRM/Submodule/GetSubModule",
            datatype: 'json',
            mtype: 'Get',
            ...
            colModel: [
                ...
                {
                    key: false, hidden: true, name: 'ModuleId', width: 140, index: 'ModuleId', editable: true, edittype: "select", editoptions: { dataUrl: '/HRM/Submodule/GetCorrespondingModules', cacheUrlData: true }, editrules: { edithidden: true, required: true },
        ...
        {
            zIndex: 100,
            url: '/HRM/Submodule/SavaSubModule',
            closeOnEscape: true,
            width: 'auto',
            height: 'auto',
            closeAfterEdit: true,
        ...
        {
            zIndex: 100,
            url: "/HRM/Submodule/DeleteSubModule",
            closeOnEscape: true,
