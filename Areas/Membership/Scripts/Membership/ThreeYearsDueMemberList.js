$(document).ready(function () {
    ...
    function ThreeYearsDueMemberListVM() {
        var self = this;
        ...
        self.setUrl = ko.computed(function () {
            self.Link1('/Membership/MembershipReport/GetThreeYearsDueMemberReport?reportTypeId=PDF&fromDate=' + moment(self.FromDate()).format('DD/MM/YYYY') + '&toDate=' + moment(self.ToDate()).format('DD/MM/YYYY') + '&businessCategory=' + self.BusinessType() + '&searchString=' + self.SearchString() + '&zone=' + self.Zone(), '_blank');
            self.Link2('/Membership/MembershipReport/GetThreeYearsDueMemberReport?reportTypeId=PDF&fromDate=' + moment(self.FromDate()).format('DD/MM/YYYY') + '&toDate=' + moment(self.ToDate()).format('DD/MM/YYYY') + '&businessCategory=' + self.BusinessType() + '&searchString=' + self.SearchString() + '&zone=' + self.Zone(), '_blank');
            self.Link3('/Membership/MembershipReport/GetThreeYearsDueMemberReport?reportTypeId=PDF&fromDate=' + moment(self.FromDate()).format('DD/MM/YYYY') + '&toDate=' + moment(self.ToDate()).format('DD/MM/YYYY') + '&businessCategory=' + self.BusinessType() + '&searchString=' + self.SearchString() + '&zone=' + self.Zone(), '_blank');

        });


        //Code by Maruf
        self.GetThreeYearsDueMemberReport = function () {
            window.open('/Membership/MembershipReport/GetThreeYearsDueMemberReport?reportTypeId=PDF&fromDate=' + moment(self.FromDate()).format('DD/MM/YYYY') + '&toDate=' + moment(self.ToDate()).format('DD/MM/YYYY') + '&businessCategory=' + self.BusinessType() + '&searchString=' + self.SearchString() + '&zone=' + self.Zone(), '_blank');
    ...
    var pavm = new ThreeYearsDueMemberListVM();
    pavm.loadInitialData(); //Code by Maruf
    ko.applyBindings(pavm, document.getElementById("DueMemberList"));
});